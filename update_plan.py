...
# 1. Update Task 5
task_5_replacement = """### Task 5: Ops service authentication and initial operations
...
# Regex replacing Task 5
content = re.sub(r'### Task 5: Ops service authentication and initial operations.*?---\n', task_5_replacement, content, flags=re.DOTALL)

# Insert Additions
content = content.replace("### Task 6: Store Cart creation and reads\n", "### Task 6: Store Cart creation and reads\n" + task_6_additions)
content = content.replace("### Task 9: NocoDB PostgreSQL boundary and operator read model\n", "### Task 9: NocoDB PostgreSQL boundary and operator read model\n" + task_9_additions)
content = content.replace("### Task 10: Persistent architecture docs and full V1 acceptance\n", "### Task 10: Persistent architecture docs and full V1 acceptance\n" + task_10_additions)

# Update Task 10 acceptance scenario
task_10_acc_old = r"""1. Create Product.
...
task_10_acc_new = """1. Create Product.
...
content = re.sub(task_10_acc_old, task_10_acc_new, content)
